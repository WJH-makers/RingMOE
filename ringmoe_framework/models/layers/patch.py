...
# ============================================================================
"""patch of ringmoe_framework"""
import mindspore.common.dtype
import mindspore.common.initializer as weight_init
from mindspore import ops as P
from ringmoe_framework.models.layers.layers import Identity, LayerNorm
...
class PatchEmbed(nn.Cell):
    ...
    def __init__(self,
        ...
        if norm_layer:
            self.norm = LayerNorm((out_features,), eps=1e-6)
...
if __name__ == '__main__':
    PatchEmbed= PatchEmbed(img_size=192, patch_size=4,out_features=128)
    x = Tensor(np.random.randint(0, 10, [4,3,192,192]),dtype=mindspore.common.dtype.float32)
    output = PatchEmbed(x)
    print(output.shape)